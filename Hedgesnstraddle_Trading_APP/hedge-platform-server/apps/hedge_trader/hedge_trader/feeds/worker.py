...
def _configure_site_runtime_defaults(frappe_module) -> None:
	...
	os.environ.setdefault("DB_PATH", str(runtime_dir / "hedge_state.db"))
...
async def _monitor_commands(worker_id: str, target: str | None, poll_seconds: int):
	from hedge_trader.trading.commands import get_pending_commands, heartbeat
...
def main(argv: list[str] | None = None):
	...
	try:
		_configure_site_runtime_defaults(frappe_module)
