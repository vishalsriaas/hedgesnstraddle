...
class BaseExecutor:
    ...
    async def _do_verify_hedge(self, price: float, in_window: bool):
        ...
        max_prem = _rp if _rp > 0 else float(self._cfg("max_premium") or 220.0)
    ...
    async def _execute(self, itm: dict, price: float):
        ...
        await self._log_session_event("entry_snapshot", {
            ...
            "conditions_at_entry": {
                "max_mark":       float(_c("max_premium") or 220),
    ...
    async def _snapshot_loop(self):
        ...
        while True:
            ...
            try:
                ...
                max_prem = float(self._cfg("max_premium") or 220)
    ...
    def get_status(self) -> dict:
        ...
        try:
            ...
            if raw:
                ...
                max_prem = role_prem if role_prem > 0 else float(self._cfg("max_premium") or 220)
