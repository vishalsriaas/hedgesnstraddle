...
class Config:
    ...
    bull_trade_start_h:          int   = 5
    bull_trade_start_m:          int   = 0
    bull_trade_end_h:            int   = 7
    ...
    bull_max_premium:            float = 220.0    # first-trader fallback
    ...
    bull_first_trader_max_premium:       float = 220.0
    bull_second_trader_max_premium:      float = 190.0
    bull_first_trader_max_time_value:    float = 219.0
    bull_second_trader_max_time_value:   float = 189.0
    ...
    bear_trade_start_h:          int   = 5
    bear_trade_start_m:          int   = 0
    bear_trade_end_h:            int   = 7
    ...
    bear_first_trader_max_premium:       float = 220.0
    bear_second_trader_max_premium:      float = 190.0
    bear_first_trader_max_time_value:    float = 219.0
    bear_second_trader_max_time_value:   float = 189.0
