...
DEFAULT_CONFIG_ITEMS = [
	("WINDOW_START", "05:30", "Entry Window Open", "time", 0, "time", 1),
	("WINDOW_END", "08:00", "Entry Window Close", "time", 0, "time", 2),
	...
	("MIN_EXPIRY_HOURS", "0.0", "Minimum Expiry Hours", "number", 0, "entry", 20),
	("MIN_STRIKE_GAP", "0", "Minimum Strike Gap", "number", 0, "entry", 21),
	("MAX_TOTAL_ASK", "400", "Maximum Combined Mark Premium", "number", 0, "entry", 25),
	("MAX_PREMIUM_GAP", "130", "Maximum Premium Gap", "number", 0, "entry", 26),
	...
	("PAPER_WALLET_USDT", "100000", "Paper Wallet USDT", "number", 0, "risk", 42),
]
