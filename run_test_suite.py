...
def run_suite():
    ...
    call_strike = active_straddle.get("call_strike") or snap.get("straddle", {}).get("live_call_strike") or 64000
    put_strike = active_straddle.get("put_strike") or snap.get("straddle", {}).get("live_put_strike") or 64000
    passed_count += 1
